...
> **技术架构参考（REFERENCE）**：基础分层和技术边界仍可参考，但其中的阶段状态、路线和代码清单可能过期。当前事实与路线分别见 `CURRENT_IMPLEMENTATION.md`、`ROADMAP.md`。
...
> **历史修订说明**（2026-07-05）：当时曾以 M1-M5 替换原阶段划分，旧索引现归档于 `archive/00_开发里程碑索引.md`。当前路线见 `ROADMAP.md`。
